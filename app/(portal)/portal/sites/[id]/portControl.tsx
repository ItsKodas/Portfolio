        ...
        <div>
            ...
            {!unchanged && (
                <p className={styles.note}>
                    Changing it rewrites the site&apos;s port variable (WEB_PORT unless the registry names another) in its .env, recreates this environment&apos;s containers and points its vhost at the new port. The site is down for a few seconds.
                </p>
            )}
