...
export default function Watchtower() {
    return (
        <svg className={styles.tower} viewBox="0 0 3840 4320" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
            <defs>
            ...
            {/* Lamp glow spilling out around the cab (not clipped, so it also lights the ridge a little) */}
            <circle className={styles.glow} cx={BASE.x} cy={BASE.y - 95 * SCALE} r={60 * SCALE} fill="url(#towerLamp)" />

            <g clipPath="url(#aboveTrees)">
            <g transform={`translate(${BASE.x} ${BASE.y}) scale(${SCALE})`}>
                ...
                <rect className={styles.window} x="-12" y="-103" width="24" height="9" fill="#ffcf7a" />
